using Tyuiu.BritovDS.Sprint4.Task4.V10.Lib;
namespace Tyuiu.BritovDS.Sprint4.Task4.V10
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Дан двумерный массив заполенный статическими                            *");
            Console.WriteLine("* значениями от 1 до 7, нечетный элемент массива заменить на 0            *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
